...
Deno.serve(async(req)=>{
  ...
  const event=JSON.parse(raw) as {platform?:string;eventId?:string;type?:string;userId?:string;productKey?:string;transactionId?:string;originalTransactionId?:string;status?:string;purchasedAt?:string;expiresAt?:string;units?:number};
