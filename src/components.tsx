...
const styles=StyleSheet.create({
  ...
  button:{minHeight:50,borderRadius:radius.pill,alignItems:'center',justifyContent:'center',flexDirection:'row',gap:8,paddingHorizontal:20},primary:{shadowColor:colors.pink,shadowOpacity:.32,shadowRadius:15,shadowOffset:{width:0,height:7}},secondary:{backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},ghost:{backgroundColor:'transparent'},gold:{backgroundColor:'#5A4310',borderWidth:1,borderColor:colors.gold},buttonIconBadge:{width:22,height:22,borderRadius:11,alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:'rgba(255,255,255,.22)',shadowColor:colors.pink,shadowOpacity:.28,shadowRadius:8},buttonText:{fontFamily:'Poppins_700Bold',fontSize:typeScale.body,letterSpacing:0,color:colors.ivory},
