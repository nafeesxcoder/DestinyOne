...
const styles=StyleSheet.create({
  ...
  chip:{borderRadius:radius.pill,borderWidth:1,borderColor:colors.line,backgroundColor:'#FFFDFC',paddingHorizontal:14,paddingVertical:10,flexDirection:'row',alignItems:'center',gap:5},chipSelected:{backgroundColor:'#F2D9DF',borderColor:colors.pinkSoft},chipGold:{backgroundColor:'#FFF1C9',borderColor:colors.gold},chipText:{color:colors.muted,fontFamily:'Poppins_600SemiBold',fontSize:12},chipCheck:{width:19,height:19,borderRadius:10,alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:colors.line,shadowColor:colors.gold,shadowOpacity:.2,shadowRadius:8},
