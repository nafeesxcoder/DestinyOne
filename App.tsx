...
function RelationshipCoach({match,preferences,onBack,onOpenFilters,onUseInChat}:{match:Match;preferences:{intent:string;vibes:string[];filters:MatchFilters};onBack:()=>void;onOpenFilters:()=>void;onUseInChat:(draft:string)=>void}){
  ...
  return <LinearGradient colors={['#FFF8F5',colors.black,colors.black]} style={{flex:1}}><SafeAreaView style={shared.safe}><View style={coachStyles.header}><Pressable onPress={onBack} style={styles.backButton}><PremiumIcon name="arrow-back" tone="dark" size={42} iconSize={20}/></Pressable><Text style={[styles.cardTitle,{marginLeft:12}]}>AI Relationship Coach</Text></View><ScrollView contentContainerStyle={coachStyles.content} showsVerticalScrollIndicator={false}>
...
function EventsHub({defaultCity,onBack,onOpenDatePlan,navigate}:{defaultCity:string;onBack:()=>void;onOpenDatePlan:(place?:PlaceItem)=>void;navigate:(screen:Screen)=>void}){
  ...
  return <LinearGradient colors={['#FFF8F3',colors.black,colors.black]} style={{flex:1}}>
...
function SafetyCenter({reports,blockedCount,datePlans,safeCheckIns,onCheckIn,onDeleteAccount,onBack}:{reports:LocalReport[];blockedCount:number;datePlans:ChatMessage[];safeCheckIns:string[];onCheckIn:(id:string)=>void;onDeleteAccount:()=>void;onBack:()=>void}){
  ...
  return <LinearGradient colors={['#FFF8F5',colors.black,colors.black]} style={{flex:1}}>
    <SafeAreaView style={shared.safe}>
...
function Profile({profile,verified,profilePhoto,hasVoiceIntro,lastSeenVisible,analyticsConsent,onLastSeenVisibleChange,onAnalyticsConsentChange,navigate,onOpenSetup,onReset}:{profile:ProfileDraft;verified:boolean;profilePhoto?:string;hasVoiceIntro:boolean;lastSeenVisible:boolean;analyticsConsent:boolean;onLastSeenVisibleChange:(value:boolean)=>void;onAnalyticsConsentChange:(value:boolean)=>void;navigate:(s:Screen)=>void;onOpenSetup:()=>void;onReset:()=>void}){
  ...
  const actions=[
    {label:'Set up profile again',icon:'refresh-outline' as const,onPress:onOpenSetup},
  ...
  return <SafeAreaView style={{flex:1}}>
    <ScrollView contentContainerStyle={{padding:22,paddingBottom:120,gap:22}}>
      ...
      <Pressable onPress={()=>void shareProfileTag()} style={[shared.card,{flexDirection:'row',alignItems:'center',gap:12,borderColor:'rgba(212,175,55,.25)',backgroundColor:'#FFF9F5'}]}>
...
const couplesMarketStyles=StyleSheet.create({
  ...
  bookingType:{width:190,minHeight:126,padding:13,borderRadius:8,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:colors.line,gap:6},
...
const gameStyles=StyleSheet.create({
  ...
  card:{minHeight:82,padding:13,borderRadius:22,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:colors.line,flexDirection:'row',alignItems:'center',gap:12},
...
const privacyStyles=StyleSheet.create({
  card:{padding:15,borderRadius:24,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(212,175,55,.22)',flexDirection:'row',gap:12,alignItems:'flex-start'},
...
const trustHubStyles=StyleSheet.create({
  ...
  actionGrid:{gap:10},
  actionCard:{padding:14,borderRadius:22,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:colors.line,flexDirection:'row',alignItems:'center',gap:12},
...
const adminOpsStyles=StyleSheet.create({
  ...
  placesReservationCard:{gap:12,padding:15,borderRadius:26,backgroundColor:'#F4FBF5',borderWidth:1,borderColor:'#B8D7C4',shadowColor:'#45C2A4',shadowOpacity:.08,shadowRadius:16},
  observabilityCard:{gap:12,padding:15,borderRadius:26,backgroundColor:'#F7F4FC',borderWidth:1,borderColor:'#D3C8EC',shadowColor:'#8B75FF',shadowOpacity:.08,shadowRadius:16},
  ...
  caseCard:{gap:12,padding:15,borderRadius:24,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:colors.line,shadowColor:colors.pink,shadowOpacity:.08,shadowRadius:14},
...
const homeStyles=StyleSheet.create({
  ...
  packageCard:{minHeight:78,borderRadius:22,overflow:'hidden',borderWidth:1,borderColor:'rgba(212,175,55,.28)',flexDirection:'row',alignItems:'center',gap:12,padding:13,backgroundColor:'#FFF9F0'},
...
const growthLoopStyles=StyleSheet.create({
  ...
  networkCard:{gap:13,padding:15,borderRadius:28,backgroundColor:'#FFF8F1',borderWidth:1,borderColor:'#E5C87C',shadowColor:colors.gold,shadowOpacity:.10,shadowRadius:20},
  ...
  retentionStat:{flex:1,minHeight:58,borderRadius:18,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:colors.line,alignItems:'center',justifyContent:'center',padding:7},
...
const ventureStyles=StyleSheet.create({
  ...
  metricCard:{width:'48%',minHeight:118,borderRadius:22,padding:14,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:colors.line,gap:8},
  ...
  conciergeCard:{gap:12,padding:18,borderRadius:28,backgroundColor:'#FFF9F5',borderWidth:1,borderColor:'rgba(212,175,55,.24)',alignItems:'center'},
  ...
  revenueRow:{padding:13,borderRadius:19,backgroundColor:'#FFF8F1',borderWidth:1,borderColor:colors.line,flexDirection:'row',alignItems:'center',gap:12},
  stagePill:{width:62,minHeight:36,borderRadius:18,backgroundColor:'#F3DDE2',alignItems:'center',justifyContent:'center',paddingHorizontal:8},
  ...
  trustMeter:{gap:12,padding:16,borderRadius:24,backgroundColor:'#FFF9F5',borderWidth:1,borderColor:colors.line},
...
const coachStyles=StyleSheet.create({
  ...
  outputCard:{gap:12,padding:16,borderRadius:22,backgroundColor:'#FFF9F5',borderWidth:1,borderColor:colors.line},
  ...
  launchCityCard:{width:205,minHeight:148,borderRadius:21,padding:12,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(255,255,255,.09)',gap:6},
  ...
  eventEmoji:{width:48,height:48,borderRadius:24,backgroundColor:'#F9E6E9',alignItems:'center',justifyContent:'center'},
  ...
  packageCard:{padding:14,borderRadius:22,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(212,175,55,.18)',flexDirection:'row',gap:12,shadowColor:'#000',shadowOpacity:.16,shadowRadius:10},
  ...
  placeCardCompact:{backgroundColor:'#FFF8F5'},
  placeIcon:{width:50,height:50,borderRadius:25,backgroundColor:'#F9E6E9',alignItems:'center',justifyContent:'center'},
  ...
  placeDetailHero:{padding:14,borderRadius:22,backgroundColor:'#FCF1F2',borderWidth:1,borderColor:colors.line,flexDirection:'row',alignItems:'center',gap:13},
  ...
  chatCoach:{paddingHorizontal:14,paddingVertical:8,gap:7,backgroundColor:'#FFF8F4',borderBottomWidth:1,borderBottomColor:colors.line},
  ...
  badgeCard:{gap:11,padding:15,borderRadius:22,backgroundColor:'#FFF8F1',borderWidth:1,borderColor:'#E5C87C'},
  ...
  partnerCta:{padding:15,borderRadius:24,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(212,175,55,.22)',flexDirection:'row',alignItems:'center',gap:12,shadowColor:colors.gold,shadowOpacity:.08,shadowRadius:12},
...
const supportStyles=StyleSheet.create({
  ...
  topicCardOn:{borderColor:colors.gold,backgroundColor:'#FFF5E4'},
...
const pricingStyles=StyleSheet.create({
  ...
  billingRailCard:{gap:12,padding:15,borderRadius:22,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(255,255,255,.09)'},
  ...
  executiveCard:{gap:16,padding:18,borderRadius:30,borderWidth:1,borderColor:'rgba(245,212,106,.45)',backgroundColor:'#FFF5DD',overflow:'hidden',shadowColor:colors.gold,shadowOpacity:.18,shadowRadius:22},
  ...
  restoreCard:{padding:14,borderRadius:22,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(255,255,255,.09)',flexDirection:'row',alignItems:'center',gap:11},
  ...
  manageCard:{gap:13,padding:15,borderRadius:22,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(229,9,47,.22)'},
...
const aiStyles=StyleSheet.create({
  aiCard:{gap:14,padding:16,borderRadius:22,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'#7A1B31'},
  ...
  roseWallet:{minHeight:76,padding:13,borderRadius:22,backgroundColor:'#FBE9EC',borderWidth:1,borderColor:'#8B1B34',flexDirection:'row',alignItems:'center',gap:12},
  roseIcon:{width:46,height:46,borderRadius:23,backgroundColor:'#F2D9DF',alignItems:'center',justifyContent:'center',shadowColor:colors.pink,shadowOpacity:.35,shadowRadius:12},
  ...
  detailAi:{gap:11,padding:16,borderRadius:22,backgroundColor:'#FFF9F0',borderWidth:1,borderColor:'rgba(212,175,55,.26)'},
  ...
  privacyPolicyCard:{padding:15,borderRadius:20,backgroundColor:'#FFF9EB',borderWidth:1,borderColor:'rgba(212,175,55,.28)',flexDirection:'row',alignItems:'center',gap:12},
...
const launchStyles=StyleSheet.create({
  ...
  orbitSpark:{position:'absolute',right:2,bottom:24,width:37,height:37,borderRadius:19,backgroundColor:'#FFF3DC',alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:'#7A5D18'},
  ...
  billingPromise:{padding:16,borderRadius:22,backgroundColor:'#FCF1F2',borderWidth:1,borderColor:'#6F275F',flexDirection:'row',alignItems:'center',gap:12},
  promiseIcon:{width:44,height:44,borderRadius:22,backgroundColor:'#F1D5DC',alignItems:'center',justifyContent:'center'},
});
...
const mediaStyles=StyleSheet.create({
  ...
  mediaAction:{flex:1,height:44,borderRadius:22,backgroundColor:'#F2D9DF',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7},
...
const chatStyles=StyleSheet.create({
  ...
  mediaBubble:{padding:4,overflow:'hidden',backgroundColor:'#F2D9DF'},
  ...
  giftBubble:{minWidth:210,alignItems:'center',padding:18,backgroundColor:'#F9E8EC',borderWidth:1,borderColor:'#892139'},
  ...
  sheet:{position:'absolute',left:0,right:0,bottom:0,backgroundColor:'#FFF8F3',borderTopLeftRadius:30,borderTopRightRadius:30,borderWidth:1,borderColor:colors.line,padding:20,gap:18},
  ...
  balance:{height:44,borderRadius:22,backgroundColor:'#FCF1F2',borderWidth:1,borderColor:'#6A1827',paddingHorizontal:14,flexDirection:'row',alignItems:'center',gap:7},
  ...
  giftCardOn:{borderColor:colors.gold,backgroundColor:'#F9E6E9',shadowColor:colors.gold,shadowOpacity:.25,shadowRadius:16},
  giftPhotoWrap:{width:'100%',height:112,borderRadius:17,overflow:'hidden',backgroundColor:'#FFF8F3',borderWidth:1,borderColor:'rgba(255,255,255,.10)',marginBottom:8},
  ...
  coinPill:{marginTop:8,flexDirection:'row',alignItems:'center',gap:4,paddingHorizontal:9,paddingVertical:5,borderRadius:12,backgroundColor:'#FFF3DC'},
  ...
  checkoutBar:{minHeight:66,borderRadius:20,padding:11,backgroundColor:'#FBE9EC',borderWidth:1,borderColor:colors.line,flexDirection:'row',alignItems:'center',gap:10},
...
const snapStyles=StyleSheet.create({
  ...
  filterChipOn:{borderColor:colors.pink,backgroundColor:'#F9E6E9'},
  ...
  emojiChoiceOn:{borderColor:colors.pink,backgroundColor:'#F2D9DF',transform:[{scale:1.05}]},
...
const circleStyles=StyleSheet.create({
  ...
  coinBalance:{height:36,borderRadius:18,backgroundColor:'#FFF3DC',borderWidth:1,borderColor:'#66521A',paddingHorizontal:11,flexDirection:'row',alignItems:'center',gap:6},
  ...
  userCircle:{width:102,height:102,borderRadius:51,backgroundColor:'#F2DDE2',borderWidth:3,borderColor:colors.pink,alignItems:'center',justifyContent:'center',shadowColor:colors.pink,shadowOpacity:.35,shadowRadius:18},
  ...
  rewardCard:{padding:15,borderRadius:20,backgroundColor:'#FFF5DD',borderWidth:1,borderColor:'#67531A',flexDirection:'row',alignItems:'center',gap:12},
  rewardIcon:{width:43,height:43,borderRadius:22,backgroundColor:'#FFF3DC',alignItems:'center',justifyContent:'center'},
  demoCard:{padding:16,borderRadius:20,backgroundColor:'#FCF1F2',borderWidth:1,borderColor:colors.line,gap:9},
  ...
  profileVouch:{padding:16,borderRadius:22,backgroundColor:'#FCF1F2',borderWidth:1,borderColor:'#6D1828',flexDirection:'row',gap:12,marginTop:12},
...
const discoveryStyles=StyleSheet.create({
  ...
  crossedName:{fontFamily:'Poppins_700Bold',fontSize:19,color:'#FFFDFC'},
  ...
  toggleIcon:{width:44,height:44,borderRadius:22,backgroundColor:'#F2D9DF',alignItems:'center',justifyContent:'center'},
  switch:{width:48,height:28,borderRadius:14,backgroundColor:'#E7D5CF',padding:3},
  ...
  privacyPoint:{width:'48%',minHeight:145,borderRadius:20,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:colors.line,padding:14,gap:7},
...
const dateStyles=StyleSheet.create({
  ...
  venueCardOn:{borderColor:colors.gold,backgroundColor:'#F9E8EC',shadowColor:colors.gold,shadowOpacity:.20,shadowRadius:14},
  ...
  safetyCard:{padding:16,borderRadius:22,backgroundColor:'#FCF1F2',borderWidth:1,borderColor:colors.line,gap:14},
  ...
  sampleNotice:{padding:13,borderRadius:16,backgroundColor:'#FFF5DD',borderWidth:1,borderColor:'#5D4B19',flexDirection:'row',gap:9},
  ...
  dateBubble:{minWidth:245,padding:14,backgroundColor:'#F2D9DF',borderWidth:1,borderColor:'#8E1C35'},
...
const safetyStyles=StyleSheet.create({
  ...
  actionIcon:{width:42,height:42,borderRadius:21,backgroundColor:'#F2D9DF',alignItems:'center',justifyContent:'center'},
  ...
  reasonOn:{backgroundColor:'#F2D9DF',borderColor:colors.pink},
  ...
  checkInIcon:{width:40,height:40,borderRadius:20,backgroundColor:'#F1D5DC',alignItems:'center',justifyContent:'center'},
  ...
  warning:{padding:15,borderRadius:20,backgroundColor:'#FFF3DC',borderWidth:1,borderColor:'#67531A',flexDirection:'row',gap:12},
