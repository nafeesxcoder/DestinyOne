...
- [x] 15% — Splash and welcome experience
- [x] 20% — Validated phone/email signup and mock OTP flow
- [x] 25% — Verification and profile setup UI
- [x] 30% — Vibes, relationship intent, and curated match feed
- [x] 35% — Match detail, mutual match, and icebreaker flow
- [x] 40% — Chat, likes, profile, safety, and Plus pricing UI
- [x] 45% — Reference-inspired neon plum visual polish and interaction system
- [x] 50% — Persist sessions, onboarding, preferences, and chat locally
- [x] 55% — Commitment-only positioning, life-alignment onboarding, and serious-profile details
- [x] 60% — Native photo picker, camera/selfie, and voice recording
- [x] 65% — Rich chat with photos, GIFs, emojis, read states, and virtual gifting
- [x] 70% — Trusted Circle, friend vouches, privacy controls, referral sharing, and rewards
- [x] 75% — Privacy-safe Smart Discovery, activity controls, and opt-in Crossed Paths
- [x] 80% — Date Planner with cafés, activities, approximate area, proposals, and safety check-ins
