...
function HomeClean({memberName,items,matchLoadState,matchingPoolStatus,onRetryMatches,preferences,alignment,signals,dismissedCount,profileGrowth,crossedPaths,openDetail,onInterested,onSkip,onRose,navigate}:{memberName:string;items:Match[];matchLoadState:MemberMatchLoadState;matchingPoolStatus:MatchingPoolStatus|null;onRetryMatches:()=>void;preferences:{intent:string;vibes:string[];filters:MatchFilters};alignment:Record<string,string>;signals:DiscoverySignal[];dismissedCount:number;profileGrowth:ProfileGrowthInput;roseAvailability:RoseAvailability;crossedPaths:boolean;openDetail:(m:Match)=>void;onInterested:(m:Match)=>void;onSkip:(m:Match)=>void;onRose:(m:Match)=>void;navigate:(s:Screen)=>void}){
  ...
  return <LinearGradient colors={['#F8F3EE','#F4EBE5',colors.black]} style={{flex:1}}><SafeAreaView style={[shared.safe,desktop?homeCleanStyles.desktopSafe:{maxWidth:920,paddingHorizontal:0}]}> 
    ...
    <View style={[homeCleanStyles.header,width<390&&homeCleanStyles.headerCompact]}>
      <View style={{flex:1}}>
        <Text style={[homeCleanStyles.greeting,width<390&&homeCleanStyles.greetingCompact]}>{timeGreeting}, {greetingName} <Text style={homeCleanStyles.wave}>👋</Text></Text>
        <Text numberOfLines={1} style={homeCleanStyles.greetingSub}>Thoughtful connections. Meaningful futures.</Text>
      </View>
      <Pressable accessibilityRole="button" accessibilityLabel="Notifications" onPress={()=>navigate('support')} style={[homeCleanStyles.notificationButton,width<390&&homeCleanStyles.headerButtonCompact]}><Ionicons name="notifications-outline" size={width<390?18:21} color="#32151F"/><View style={homeCleanStyles.notificationBadge}><Text style={homeCleanStyles.notificationBadgeText}>3</Text></View></Pressable>
      <Pressable accessibilityRole="button" accessibilityLabel="Match filters" onPress={()=>navigate('discovery')} style={[homeCleanStyles.headerButton,width<390&&homeCleanStyles.headerButtonCompact]}><PremiumIcon name="options-outline" tone="dark" size={width<390?34:36} iconSize={width<390?15:17}/></Pressable>
      <Pressable accessibilityRole="button" accessibilityLabel="Open profile" onPress={()=>navigate('profile')} style={[homeCleanStyles.headerButton,width<390&&homeCleanStyles.headerButtonCompact]}><PremiumIcon name="person-outline" tone="ruby" size={width<390?34:36} iconSize={width<390?15:17}/></Pressable>
    </View>
...
const selectorStyles=StyleSheet.create({
  ...
  countrySegment:{height:46,borderRadius:10,padding:3,backgroundColor:'#F5ECE7',borderWidth:1,borderColor:'#E6D7CC',flexDirection:'row'},
...
const coupleModeStyles=StyleSheet.create({
  modeGrid:{gap:12},
  modeCard:{padding:15,gap:13,borderRadius:12,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:'#E6D7CC',shadowColor:'#4A1826',shadowOpacity:.08,shadowRadius:12},
  modeCardOn:{backgroundColor:'#F9E6EA',borderColor:'#B78A2F',shadowColor:colors.gold,shadowOpacity:.12,shadowRadius:16},
  ...
  modePoints:{flexDirection:'row',flexWrap:'wrap',gap:7,paddingTop:11,borderTopWidth:1,borderTopColor:'#EDE1D9'},
  modePoint:{minHeight:30,paddingHorizontal:9,paddingVertical:6,borderRadius:15,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'#E8D8D2',flexDirection:'row',alignItems:'center',gap:5},
  modePointOn:{backgroundColor:'#FFF3D7',borderColor:'rgba(183,138,47,.32)'},
  modePointText:{fontFamily:'Poppins_600SemiBold',fontSize:9.5,lineHeight:14,color:'#432630'},
  modePromise:{padding:13,borderRadius:10,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'#E6D7CC',flexDirection:'row',alignItems:'center',gap:10},
...
const profilePremiumStyles=StyleSheet.create({
  ...
  shareStatusText:{flex:1,fontFamily:'Poppins_600SemiBold',fontSize:10.8,lineHeight:16,color:'#6F5A32'},
});
...
const homeCleanStyles=StyleSheet.create({
  ...
  headerCompact:{minHeight:64,paddingHorizontal:12,gap:5},
  greeting:{fontFamily:'Georgia',fontSize:26,color:'#24171A'},
  greetingCompact:{fontSize:21,lineHeight:25},
  ...
  headerButtonCompact:{width:34,height:34,borderRadius:17},
...
const ventureStyles=StyleSheet.create({
  ...
  metricCard:{width:'48%',minHeight:118,borderRadius:22,padding:14,backgroundColor:'#2A0B14',borderWidth:1,borderColor:'rgba(183,138,47,.42)',gap:8,shadowColor:'#6F1627',shadowOpacity:.12,shadowRadius:10,shadowOffset:{width:0,height:5}},
  ...
  metricLabel:{fontFamily:'Poppins_700Bold',fontSize:9.5,letterSpacing:1.1,color:'#F08AA6',textTransform:'uppercase'},
  metricValue:{fontFamily:'Poppins_700Bold',fontSize:13.5,lineHeight:18,color:'#FFF8F5'},
  actionGrid:{gap:10},
  section:{gap:12},
  ...
  priceSealSub:{fontFamily:'Poppins_600SemiBold',fontSize:9.5,color:'#6E5630',marginTop:2},
  ...
  statusTitle:{fontFamily:'Poppins_700Bold',fontSize:12.5,color:'#24171A',marginBottom:3},
...
const supportStyles=StyleSheet.create({
  ...
  topicCardOn:{borderColor:colors.gold,backgroundColor:'#FFF3D7'},
  ...
  quickCard:{width:'48%',minHeight:125,borderRadius:16,padding:13,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:'#E6D7CC',gap:8},
  ...
  infoList:{gap:8},
  infoRow:{padding:11,borderRadius:12,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:'#E6D7CC',flexDirection:'row',alignItems:'center',gap:9},
  infoText:{flex:1,fontFamily:'Poppins_600SemiBold',fontSize:11,lineHeight:16,color:'#432630'},
...
const referralStyles=StyleSheet.create({
  ...
  close:{position:'absolute',right:22,top:22,zIndex:4,width:34,height:34,borderRadius:17,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:'#E6D7CC',alignItems:'center',justifyContent:'center'},
  ...
  body:{fontFamily:'Poppins_400Regular',fontSize:11.5,lineHeight:17.5,color:'#F8DFE4',textAlign:'center',maxWidth:470},
  rewardCard:{gap:10,padding:13,borderRadius:12,backgroundColor:'#FFF8F5',borderWidth:1,borderColor:'rgba(168,12,54,.28)'},
  ...
  rewardPill:{paddingHorizontal:8,paddingVertical:5,borderRadius:7,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:'#E7D8D1'},
  rewardPillText:{fontFamily:'Poppins_600SemiBold',fontSize:8,color:'#432630'},
  steps:{gap:8},
  stepsWide:{flexDirection:'row'},
  step:{minHeight:44,flexDirection:'row',alignItems:'center',gap:10,paddingHorizontal:11,paddingVertical:8,borderRadius:10,backgroundColor:'#FFFDFC',borderWidth:1,borderColor:'#E7D8D1'},
  ...
  stepText:{flex:1,fontFamily:'Poppins_600SemiBold',fontSize:9.8,lineHeight:14.5,color:'#432630'},
  codeRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',padding:12,borderRadius:10,backgroundColor:'#FFF7E5',borderWidth:1,borderColor:'rgba(183,138,47,.36)'},
  ...
  profileBanner:{minHeight:116,flexDirection:'row',alignItems:'center',gap:12,padding:16,borderRadius:12,borderWidth:1,borderColor:'rgba(183,138,47,.40)',backgroundColor:'#FFF7E5',overflow:'hidden'},
});
...
const chatStyles=StyleSheet.create({
  ...
  sheet:{position:'absolute',left:0,right:0,bottom:0,backgroundColor:'#FFFDFC',borderTopLeftRadius:24,borderTopRightRadius:24,borderWidth:1,borderColor:colors.line,padding:20,gap:18},
...
const dateStyles=StyleSheet.create({
  ...
  messageEyebrow:{fontFamily:'Poppins_700Bold',fontSize:8,letterSpacing:1,color:'#F6A4B9'},
  messageVenue:{fontFamily:'Poppins_700Bold',fontSize:17,color:'#FFF8F5',marginTop:2},
  ...
  messageLineText:{fontFamily:'Poppins_400Regular',fontSize:11,color:'#F3D7DE',flex:1},
  ...
  dateFlowText:{fontFamily:'Poppins_600SemiBold',fontSize:7.5,color:'#D9B7C0',textAlign:'center'},
  dateFlowTextOn:{color:'#F7DFA8'},
  waitingText:{fontFamily:'Poppins_600SemiBold',fontSize:9.5,color:'#F6A4B9',marginTop:10},
});
