export const deploymentContract = {
  ...
  tables: [
    ...
    'growth_campaigns',
    'growth_experiment_approvals',
    'growth_experiment_metric_snapshots',
    'growth_experiment_decisions',
    'growth_referral_risk_reviews',
    'growth_cohort_ingestion_runs',
    'billing_products',
    ...
    'date_plan_events',
    'call_sessions',
    'billing_verification_attempts',
    'launch_analytics_sessions',
  ...
  rpcs: [
    ...
    'record_growth_experiment_exposure',
    'record_growth_experiment_metric_snapshot',
    'decide_growth_experiment',
    'review_growth_referral_risk',
    'reverse_growth_referral_reward',
    'record_growth_cohort_snapshot',
    'withdraw_growth_analytics_consent',
    ...
    'update_date_proposal_lifecycle',
    ...
    'close_launch_analytics_session',
    'get_launch_analytics_snapshot',
  ],
};
