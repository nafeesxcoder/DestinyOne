...
2. Link development first and apply migrations 001-029 in order.
...
- Supabase CLI 2.109.1 is pinned, local config is initialized, and a 258-assertion
...
- Migrations 001-029 are source-ready but have not been applied to a linked Supabase
